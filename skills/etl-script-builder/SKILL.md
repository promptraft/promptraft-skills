---
name: DAT-047-etl-script-builder
...
- **Intent:** Detect user intent related to *etl script builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *etl script builder* context
  2. `Construct enterprise DAG strategy matching ETL Script Builder`
