---
name: LEG-036-warranty-disclaimer-writer
...
- **Intent:** Detect user intent related to *warranty disclaimer writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *warranty disclaimer writer* context
  2. `Construct enterprise DAG strategy matching Warranty Disclaimer Writer`
...
skill:
  id: LEG-036
  name: "Warranty Disclaimer Writer"
  domain: Legal
  version: 1.0.0
  difficulty: Expert
  type: Generative
