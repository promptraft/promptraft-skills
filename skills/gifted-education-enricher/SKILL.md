---
name: EDU-017-gifted-education-enricher
...
- **Intent:** Detect user intent related to *gifted education enricher*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *gifted education enricher* context
  2. `Construct enterprise DAG strategy matching Gifted Education Enricher`
...
skill:
  id: EDU-017
  name: "Gifted Education Enricher"
  domain: Education
  version: 1.0.0
  difficulty: Beginner
  type: Analytical
