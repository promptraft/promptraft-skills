...
- **Intent:** Detect user intent related to *bundle analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *bundle analyzer* context
  2. `Construct enterprise DAG strategy matching Bundle Analyzer`
