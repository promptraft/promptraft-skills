---
name: WEB-107-intersection-observer-wrapper
...
- **Intent:** Detect user intent related to *intersection observer wrapper*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *intersection observer wrapper* context
  2. `Construct enterprise DAG strategy matching Intersection Observer Wrapper`
...
skill:
  id: WEB-107
  name: "Intersection Observer Wrapper"
  domain: Web Development
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
