---
name: FIN-041-dilution-analyzer
...
- **Intent:** Detect user intent related to *dilution analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *dilution analyzer* context
  2. `Construct enterprise DAG strategy matching Dilution Analyzer`
