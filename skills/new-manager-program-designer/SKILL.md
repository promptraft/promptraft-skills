---
name: HR-085-new-manager-program-designer
...
- **Intent:** Detect user intent related to *new manager program designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *new manager program designer* context
  2. `Construct enterprise DAG strategy matching New Manager Program Designer`
...
skill:
  id: HR-085
  name: "New Manager Program Designer"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Transformative
