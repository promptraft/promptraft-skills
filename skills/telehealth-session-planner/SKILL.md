---
name: HEA-057-telehealth-session-planner
...
- **Intent:** Detect user intent related to *telehealth session planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *telehealth session planner* context
  2. `Construct enterprise DAG strategy matching Telehealth Session Planner`
...
skill:
  id: HEA-057
  name: "Telehealth Session Planner"
  domain: Healthcare
  version: 1.0.0
  difficulty: Beginner
  type: Analytical
