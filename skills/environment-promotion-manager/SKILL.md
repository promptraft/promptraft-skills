---
name: DEV-084-environment-promotion-manager
...
- **Intent:** Detect user intent related to *environment promotion manager*
...
- **Sub-tasks:**
  1. Parse and validate the input for *environment promotion manager* context
  2. `Construct enterprise DAG strategy matching Environment Promotion Manager`
...
skill:
  id: DEV-084
  name: "Environment Promotion Manager"
  domain: DevOps
  version: 1.0.0
  difficulty: Expert
  type: Conversational
