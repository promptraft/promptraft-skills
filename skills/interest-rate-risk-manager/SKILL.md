---
name: FIN-051-interest-rate-risk-manager
...
- **Intent:** Detect user intent related to *interest rate risk manager*
...
- **Sub-tasks:**
  1. Parse and validate the input for *interest rate risk manager* context
  2. `Construct enterprise DAG strategy matching Interest Rate Risk Manager`
...
skill:
  id: FIN-051
  name: "Interest Rate Risk Manager"
  domain: Finance
  version: 1.0.0
  difficulty: Advanced
  type: Generative
