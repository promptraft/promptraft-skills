---
name: DAT-066-multi-arm-bandit-optimizer
...
- **Intent:** Detect user intent related to *multi-arm bandit optimizer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *multi-arm bandit optimizer* context
  2. `Construct enterprise DAG strategy matching Multi-arm Bandit Optimizer`
...
skill:
  id: DAT-066
  name: "Multi-arm Bandit Optimizer"
  domain: Data Science
  version: 1.0.0
  difficulty: Intermediate
  type: Generative
