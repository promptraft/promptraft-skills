---
name: HEA-011-hipaa-compliance-checker
...
- **Intent:** Detect user intent related to *hipaa compliance checker*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *hipaa compliance checker* context
  2. `Construct enterprise DAG strategy matching HIPAA Compliance Checker`
