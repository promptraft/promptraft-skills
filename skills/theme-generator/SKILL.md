...
- **Intent:** Detect user intent related to *theme generator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *theme generator* context
  2. `Construct enterprise DAG strategy matching Theme Generator`
