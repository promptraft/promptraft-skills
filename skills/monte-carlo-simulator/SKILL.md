---
name: FIN-065-monte-carlo-simulator
...
- **Intent:** Detect user intent related to *monte carlo simulator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *monte carlo simulator* context
  2. `Construct enterprise DAG strategy matching Monte Carlo Simulator`
