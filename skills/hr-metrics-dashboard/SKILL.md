---
name: HR-059-hr-metrics-dashboard
...
- **Intent:** Detect user intent related to *hr metrics dashboard*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *hr metrics dashboard* context
  2. `Construct enterprise DAG strategy matching HR Metrics Dashboard`
