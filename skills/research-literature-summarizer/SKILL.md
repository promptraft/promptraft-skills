---
name: HEA-035-research-literature-summarizer
...
# Research Literature Summarizer
...
- **Intent:** Detect user intent related to *research literature summarizer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *research literature summarizer* context
  2. `Construct enterprise DAG strategy matching Research Literature Summarizer`
...
skill:
  id: HEA-035
  name: "Research Literature Summarizer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Advanced
  type: Transformative
