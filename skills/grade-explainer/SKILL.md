...
- **Intent:** Detect user intent related to *grade explainer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *grade explainer* context
  2. `Construct enterprise DAG strategy matching Grade Explainer`
