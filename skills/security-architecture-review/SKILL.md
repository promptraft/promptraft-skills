---
name: SEC-083-security-architecture-review
...
- **Intent:** Detect user intent related to *security architecture review*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *security architecture review* context
  2. `Construct enterprise DAG strategy matching Security Architecture Review`
