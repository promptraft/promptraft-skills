---
name: LEG-023-soc2-legal-review
...
- **Intent:** Detect user intent related to *soc2 legal review*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *soc2 legal review* context
  2. `Construct enterprise DAG strategy matching SOC2 Legal Review`
