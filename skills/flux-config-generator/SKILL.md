---
name: DEV-059-flux-config-generator
...
- **Intent:** Detect user intent related to *flux config generator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *flux config generator* context
  2. `Construct enterprise DAG strategy matching Flux Config Generator`
