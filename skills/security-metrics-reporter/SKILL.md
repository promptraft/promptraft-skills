---
name: SEC-068-security-metrics-reporter
...
- **Intent:** Detect user intent related to *security metrics reporter*
...
- **Sub-tasks:**
  1. Parse and validate the input for *security metrics reporter* context
  2. `Construct enterprise DAG strategy matching Security Metrics Reporter`
...
skill:
  id: SEC-068
  name: "Security Metrics Reporter"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Expert
  type: Agentic
