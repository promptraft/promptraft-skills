---
name: FIN-053-collections-priority-engine
...
- **Intent:** Detect user intent related to *collections priority engine*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *collections priority engine* context
  2. `Construct enterprise DAG strategy matching Collections Priority Engine`
