---
name: FIN-049-treasury-management-planner
...
- **Intent:** Detect user intent related to *treasury management planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *treasury management planner* context
  2. `Construct enterprise DAG strategy matching Treasury Management Planner`
...
skill:
  id: FIN-049
  name: "Treasury Management Planner"
  domain: Finance
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
