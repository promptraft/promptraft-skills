---
name: SEC-097-mobile-app-security-tester
...
- **Intent:** Detect user intent related to *mobile app security tester*
...
- **Sub-tasks:**
  1. Parse and validate the input for *mobile app security tester* context
  2. `Construct enterprise DAG strategy matching Mobile App Security Tester`
...
skill:
  id: SEC-097
  name: "Mobile App Security Tester"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Beginner
  type: Analytical
