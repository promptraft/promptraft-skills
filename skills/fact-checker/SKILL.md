...
- **Intent:** Detect user intent related to *fact checker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *fact checker* context
  2. `Construct enterprise DAG strategy matching Fact Checker`
