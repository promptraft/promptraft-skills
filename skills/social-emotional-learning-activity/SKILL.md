---
name: EDU-062-social-emotional-learning-activity
...
- **Intent:** Detect user intent related to *social-emotional learning activity*
...
- **Sub-tasks:**
  1. Parse and validate the input for *social-emotional learning activity* context
  2. `Construct enterprise DAG strategy matching Social-Emotional Learning Activity`
...
skill:
  id: EDU-062
  name: "Social-Emotional Learning Activity"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Analytical
