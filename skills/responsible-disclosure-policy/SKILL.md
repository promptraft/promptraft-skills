---
name: SEC-071-responsible-disclosure-policy
...
- **Intent:** Detect user intent related to *responsible disclosure policy*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *responsible disclosure policy* context
  2. `Construct enterprise DAG strategy matching Responsible Disclosure Policy`
