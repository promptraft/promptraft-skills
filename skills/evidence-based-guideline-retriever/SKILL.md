---
name: HEA-033-evidence-based-guideline-retriever
...
# Evidence-based Guideline Retriever
...
- **Intent:** Detect user intent related to *evidence-based guideline retriever*
...
- **Sub-tasks:**
  1. Parse and validate the input for *evidence-based guideline retriever* context
  2. `Construct enterprise DAG strategy matching Evidence-based Guideline Retriever`
...
skill:
  id: HEA-033
  name: "Evidence-based Guideline Retriever"
  domain: Healthcare
  version: 1.0.0
  difficulty: Beginner
  type: Agentic
