---
name: HEA-006-prior-authorization-request-writer
...
# Prior Authorization Request Writer
...
- **Intent:** Detect user intent related to *prior authorization request writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *prior authorization request writer* context
  2. `Construct enterprise DAG strategy matching Prior Authorization Request Writer`
...
skill:
  id: HEA-006
  name: "Prior Authorization Request Writer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Intermediate
  type: Generative
