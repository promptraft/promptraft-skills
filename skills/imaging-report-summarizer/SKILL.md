---
name: HEA-026-imaging-report-summarizer
...
- **Intent:** Detect user intent related to *imaging report summarizer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *imaging report summarizer* context
  2. `Construct enterprise DAG strategy matching Imaging Report Summarizer`
...
skill:
  id: HEA-026
  name: "Imaging Report Summarizer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Intermediate
  type: Generative
