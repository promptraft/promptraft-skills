...
- **Intent:** Detect user intent related to *pca reducer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pca reducer* context
  2. `Construct enterprise DAG strategy matching PCA Reducer`
