---
name: HEA-083-community-health-worker-script
...
- **Intent:** Detect user intent related to *community health worker script*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *community health worker script* context
  2. `Construct enterprise DAG strategy matching Community Health Worker Script`
...
skill:
  id: HEA-083
  name: "Community Health Worker Script"
  domain: Healthcare
  version: 1.0.0
  difficulty: Advanced
  type: Agentic
