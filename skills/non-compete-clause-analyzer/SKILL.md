---
name: LEG-008-non-compete-clause-analyzer
...
- **Intent:** Detect user intent related to *non-compete clause analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *non-compete clause analyzer* context
  2. `Construct enterprise DAG strategy matching Non-compete Clause Analyzer`
...
skill:
  id: LEG-008
  name: "Non-compete Clause Analyzer"
  domain: Legal
  version: 1.0.0
  difficulty: Expert
  type: Agentic
