...
- **Intent:** Detect user intent related to *esg scorer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *esg scorer* context
  2. `Construct enterprise DAG strategy matching ESG Scorer`
