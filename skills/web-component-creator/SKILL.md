---
name: WEB-095-web-component-creator
...
- **Intent:** Detect user intent related to *web component creator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *web component creator* context
  2. `Construct enterprise DAG strategy matching Web Component Creator`
