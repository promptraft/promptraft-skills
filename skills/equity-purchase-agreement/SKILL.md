---
name: LEG-048-equity-purchase-agreement
...
- **Intent:** Detect user intent related to *equity purchase agreement*
...
- **Sub-tasks:**
  1. Parse and validate the input for *equity purchase agreement* context
  2. `Construct enterprise DAG strategy matching Equity Purchase Agreement`
...
skill:
  id: LEG-048
  name: "Equity Purchase Agreement"
  domain: Legal
  version: 1.0.0
  difficulty: Expert
  type: Agentic
