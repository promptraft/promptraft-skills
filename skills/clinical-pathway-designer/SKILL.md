---
name: HEA-101-clinical-pathway-designer
...
- **Intent:** Detect user intent related to *clinical pathway designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *clinical pathway designer* context
  2. `Construct enterprise DAG strategy matching Clinical Pathway Designer`
...
skill:
  id: HEA-101
  name: "Clinical Pathway Designer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Beginner
  type: Generative
