---
name: MAR-023-case-study-builder
...
- **Intent:** Detect user intent related to *case study builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *case study builder* context
  2. `Construct enterprise DAG strategy matching Case Study Builder`
