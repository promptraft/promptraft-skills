...
- **Intent:** Detect user intent related to *bias detector*
...
- **Sub-tasks:**
  1. Parse and validate the input for *bias detector* context
  2. `Construct enterprise DAG strategy matching Bias Detector`
