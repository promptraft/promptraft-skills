...
- **Intent:** Detect user intent related to *funnel analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *funnel analyzer* context
  2. `Construct enterprise DAG strategy matching Funnel Analyzer`
