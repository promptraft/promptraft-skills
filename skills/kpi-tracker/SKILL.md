...
- **Intent:** Detect user intent related to *kpi tracker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *kpi tracker* context
  2. `Construct enterprise DAG strategy matching KPI Tracker`
