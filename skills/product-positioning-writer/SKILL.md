---
name: MAR-019-product-positioning-writer
...
- **Intent:** Detect user intent related to *product positioning writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *product positioning writer* context
  2. `Construct enterprise DAG strategy matching Product Positioning Writer`
...
skill:
  id: MAR-019
  name: "Product Positioning Writer"
  domain: Marketing
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
