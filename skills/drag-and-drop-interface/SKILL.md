---
name: WEB-065-drag-and-drop-interface
...
- **Intent:** Detect user intent related to *drag-and-drop interface*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *drag-and-drop interface* context
  2. `Construct enterprise DAG strategy matching Drag-and-Drop Interface`
