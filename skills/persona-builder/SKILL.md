...
- **Intent:** Detect user intent related to *persona builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *persona builder* context
  2. `Construct enterprise DAG strategy matching Persona Builder`
