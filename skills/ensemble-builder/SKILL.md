...
- **Intent:** Detect user intent related to *ensemble builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *ensemble builder* context
  2. `Construct enterprise DAG strategy matching Ensemble Builder`
