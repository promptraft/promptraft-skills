---
name: EDU-065-classroom-management-plan
...
- **Intent:** Detect user intent related to *classroom management plan*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *classroom management plan* context
  2. `Construct enterprise DAG strategy matching Classroom Management Plan`
...
skill:
  id: EDU-065
  name: "Classroom Management Plan"
  domain: Education
  version: 1.0.0
  difficulty: Beginner
  type: Transformative
