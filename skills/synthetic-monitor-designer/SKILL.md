---
name: DEV-076-synthetic-monitor-designer
...
- **Intent:** Detect user intent related to *synthetic monitor designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *synthetic monitor designer* context
  2. `Construct enterprise DAG strategy matching Synthetic Monitor Designer`
...
skill:
  id: DEV-076
  name: "Synthetic Monitor Designer"
  domain: DevOps
  version: 1.0.0
  difficulty: Expert
  type: Generative
