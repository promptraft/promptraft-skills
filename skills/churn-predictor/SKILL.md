...
- **Intent:** Detect user intent related to *churn predictor*
...
- **Sub-tasks:**
  1. Parse and validate the input for *churn predictor* context
  2. `Construct enterprise DAG strategy matching Churn Predictor`
