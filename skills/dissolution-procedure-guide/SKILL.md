---
name: LEG-045-dissolution-procedure-guide
...
- **Intent:** Detect user intent related to *dissolution procedure guide*
...
- **Sub-tasks:**
  1. Parse and validate the input for *dissolution procedure guide* context
  2. `Construct enterprise DAG strategy matching Dissolution Procedure Guide`
...
skill:
  id: LEG-045
  name: "Dissolution Procedure Guide"
  domain: Legal
  version: 1.0.0
  difficulty: Beginner
  type: Transformative
