...
- **Intent:** Detect user intent related to *siem rule writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *siem rule writer* context
  2. `Construct enterprise DAG strategy matching SIEM Rule Writer`
