...
- **Intent:** Detect user intent related to *arr/mrr tracker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *arr/mrr tracker* context
  2. `Construct enterprise DAG strategy matching ARR/MRR Tracker`
