...
- **Intent:** Detect user intent related to *cohort analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *cohort analyzer* context
  2. `Construct enterprise DAG strategy matching Cohort Analyzer`
