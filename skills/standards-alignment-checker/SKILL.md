---
name: EDU-050-standards-alignment-checker
...
- **Intent:** Detect user intent related to *standards alignment checker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *standards alignment checker* context
  2. `Construct enterprise DAG strategy matching Standards Alignment Checker`
...
skill:
  id: EDU-050
  name: "Standards Alignment Checker"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Transformative
