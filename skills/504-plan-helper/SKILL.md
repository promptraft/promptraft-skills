...
- **Intent:** Detect user intent related to *504 plan helper*
...
- **Sub-tasks:**
  1. Parse and validate the input for *504 plan helper* context
  2. `Construct enterprise DAG strategy matching 504 Plan Helper`
