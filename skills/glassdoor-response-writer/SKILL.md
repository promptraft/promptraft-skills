---
name: HR-070-glassdoor-response-writer
...
- **Intent:** Detect user intent related to *glassdoor response writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *glassdoor response writer* context
  2. `Construct enterprise DAG strategy matching Glassdoor Response Writer`
...
skill:
  id: HR-070
  name: "Glassdoor Response Writer"
  domain: Human Resources
  version: 1.0.0
  difficulty: Intermediate
  type: Transformative
