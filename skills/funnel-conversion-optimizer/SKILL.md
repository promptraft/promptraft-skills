---
name: MAR-040-funnel-conversion-optimizer
...
- **Intent:** Detect user intent related to *funnel conversion optimizer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *funnel conversion optimizer* context
  2. `Construct enterprise DAG strategy matching Funnel Conversion Optimizer`
...
skill:
  id: MAR-040
  name: "Funnel Conversion Optimizer"
  domain: Marketing
  version: 1.0.0
  difficulty: Expert
  type: Transformative
