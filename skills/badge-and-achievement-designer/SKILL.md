---
name: EDU-026-badge-and-achievement-designer
...
# Badge and Achievement Designer
...
- **Intent:** Detect user intent related to *badge and achievement designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *badge and achievement designer* context
  2. `Construct enterprise DAG strategy matching Badge and Achievement Designer`
...
skill:
  id: EDU-026
  name: "Badge and Achievement Designer"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Generative
