---
name: FIN-035-dividend-reinvestment-planner
...
- **Intent:** Detect user intent related to *dividend reinvestment planner*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *dividend reinvestment planner* context
  2. `Construct enterprise DAG strategy matching Dividend Reinvestment Planner`
...
skill:
  id: FIN-035
  name: "Dividend Reinvestment Planner"
  domain: Finance
  version: 1.0.0
  difficulty: Advanced
  type: Transformative
