---
name: HEA-072-pressure-injury-predictor
...
- **Intent:** Detect user intent related to *pressure injury predictor*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pressure injury predictor* context
  2. `Construct enterprise DAG strategy matching Pressure Injury Predictor`
...
skill:
  id: HEA-072
  name: "Pressure Injury Predictor"
  domain: Healthcare
  version: 1.0.0
  difficulty: Expert
  type: Analytical
