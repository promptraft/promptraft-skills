...
- **Intent:** Detect user intent related to *anomaly detector*
...
- **Sub-tasks:**
  1. Parse and validate the input for *anomaly detector* context
  2. `Construct enterprise DAG strategy matching Anomaly Detector`
