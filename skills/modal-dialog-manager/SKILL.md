---
name: WEB-077-modal-dialog-manager
...
- **Intent:** Detect user intent related to *modal/dialog manager*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *modal/dialog manager* context
  2. `Construct enterprise DAG strategy matching Modal/Dialog Manager`
