---
name: WEB-103-speech-recognition-wrapper
...
- **Intent:** Detect user intent related to *speech recognition wrapper*
...
- **Sub-tasks:**
  1. Parse and validate the input for *speech recognition wrapper* context
  2. `Construct enterprise DAG strategy matching Speech Recognition Wrapper`
...
skill:
  id: WEB-103
  name: "Speech Recognition Wrapper"
  domain: Web Development
  version: 1.0.0
  difficulty: Advanced
  type: Agentic
