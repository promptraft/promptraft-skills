---
name: MAR-005-seo-keyword-researcher
...
- **Intent:** Detect user intent related to *seo keyword researcher*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *seo keyword researcher* context
  2. `Construct enterprise DAG strategy matching SEO Keyword Researcher`
