---
name: HR-077-hr-chatbot-script-builder
...
- **Intent:** Detect user intent related to *hr chatbot script builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *hr chatbot script builder* context
  2. `Construct enterprise DAG strategy matching HR Chatbot Script Builder`
...
skill:
  id: HR-077
  name: "HR Chatbot Script Builder"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Analytical
