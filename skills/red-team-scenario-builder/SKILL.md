---
name: SEC-077-red-team-scenario-builder
...
- **Intent:** Detect user intent related to *red team scenario builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *red team scenario builder* context
  2. `Construct enterprise DAG strategy matching Red Team Scenario Builder`
