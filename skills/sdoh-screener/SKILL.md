...
- **Intent:** Detect user intent related to *sdoh screener*
...
- **Sub-tasks:**
  1. Parse and validate the input for *sdoh screener* context
  2. `Construct enterprise DAG strategy matching SDOH Screener`
