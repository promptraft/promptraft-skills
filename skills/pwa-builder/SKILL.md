...
- **Intent:** Detect user intent related to *pwa builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pwa builder* context
  2. `Construct enterprise DAG strategy matching PWA Builder`
