...
- **Intent:** Detect user intent related to *fraud detector*
...
- **Sub-tasks:**
  1. Parse and validate the input for *fraud detector* context
  2. `Construct enterprise DAG strategy matching Fraud Detector`
