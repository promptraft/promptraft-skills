---
name: DAT-011-time-series-forecaster
...
- **Intent:** Detect user intent related to *time series forecaster*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *time series forecaster* context
  2. `Construct enterprise DAG strategy matching Time Series Forecaster`
