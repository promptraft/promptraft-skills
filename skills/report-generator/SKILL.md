...
- **Intent:** Detect user intent related to *report generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *report generator* context
  2. `Construct enterprise DAG strategy matching Report Generator`
