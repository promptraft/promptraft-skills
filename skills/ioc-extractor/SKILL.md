...
- **Intent:** Detect user intent related to *ioc extractor*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *ioc extractor* context
  2. `Construct enterprise DAG strategy matching IOC Extractor`
