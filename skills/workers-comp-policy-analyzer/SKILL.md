---
name: LEG-067-workers-comp-policy-analyzer
...
- **Intent:** Detect user intent related to *workers comp policy analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *workers comp policy analyzer* context
  2. `Construct enterprise DAG strategy matching Workers Comp Policy Analyzer`
...
skill:
  id: LEG-067
  name: "Workers Comp Policy Analyzer"
  domain: Legal
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
