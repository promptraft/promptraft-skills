---
name: HEA-009-denial-management-assistant
...
- **Intent:** Detect user intent related to *denial management assistant*
...
- **Sub-tasks:**
  1. Parse and validate the input for *denial management assistant* context
  2. `Construct enterprise DAG strategy matching Denial Management Assistant`
...
skill:
  id: HEA-009
  name: "Denial Management Assistant"
  domain: Healthcare
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
