---
name: FIN-022-amortization-table-builder
...
- **Intent:** Detect user intent related to *amortization table builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *amortization table builder* context
  2. `Construct enterprise DAG strategy matching Amortization Table Builder`
...
skill:
  id: FIN-022
  name: "Amortization Table Builder"
  domain: Finance
  version: 1.0.0
  difficulty: Intermediate
  type: Analytical
