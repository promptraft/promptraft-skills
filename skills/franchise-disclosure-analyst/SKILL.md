---
name: LEG-097-franchise-disclosure-analyst
...
- **Intent:** Detect user intent related to *franchise disclosure analyst*
...
- **Sub-tasks:**
  1. Parse and validate the input for *franchise disclosure analyst* context
  2. `Construct enterprise DAG strategy matching Franchise Disclosure Analyst`
...
skill:
  id: LEG-097
  name: "Franchise Disclosure Analyst"
  domain: Legal
  version: 1.0.0
  difficulty: Beginner
  type: Analytical
