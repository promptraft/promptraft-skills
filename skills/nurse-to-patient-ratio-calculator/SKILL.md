---
name: HEA-056-nurse-to-patient-ratio-calculator
...
- **Intent:** Detect user intent related to *nurse-to-patient ratio calculator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *nurse-to-patient ratio calculator* context
  2. `Construct enterprise DAG strategy matching Nurse-to-Patient Ratio Calculator`
...
skill:
  id: HEA-056
  name: "Nurse-to-Patient Ratio Calculator"
  domain: Healthcare
  version: 1.0.0
  difficulty: Expert
  type: Generative
