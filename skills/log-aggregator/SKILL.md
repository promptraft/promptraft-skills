...
- **Intent:** Detect user intent related to *log aggregator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *log aggregator* context
  2. `Construct enterprise DAG strategy matching Log Aggregator`
