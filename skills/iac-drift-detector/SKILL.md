---
name: SEC-077-iac-drift-detector
...
- **Intent:** Detect user intent related to *iac drift detector*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *iac drift detector* context
  2. `Construct enterprise DAG strategy matching IaC Drift Detector`
