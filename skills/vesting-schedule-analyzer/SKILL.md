---
name: LEG-055-vesting-schedule-analyzer
...
- **Intent:** Detect user intent related to *vesting schedule analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *vesting schedule analyzer* context
  2. `Construct enterprise DAG strategy matching Vesting Schedule Analyzer`
...
skill:
  id: LEG-055
  name: "Vesting Schedule Analyzer"
  domain: Legal
  version: 1.0.0
  difficulty: Advanced
  type: Transformative
