---
name: EDU-075-synchronous-session-planner
...
- **Intent:** Detect user intent related to *synchronous session planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *synchronous session planner* context
  2. `Construct enterprise DAG strategy matching Synchronous Session Planner`
...
skill:
  id: EDU-075
  name: "Synchronous Session Planner"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Transformative
