...
- **Intent:** Detect user intent related to *nps analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *nps analyzer* context
  2. `Construct enterprise DAG strategy matching NPS Analyzer`
