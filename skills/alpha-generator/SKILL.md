...
- **Intent:** Detect user intent related to *alpha generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *alpha generator* context
  2. `Construct enterprise DAG strategy matching Alpha Generator`
