---
name: LEG-091-contract-redlining-assistant
...
- **Intent:** Detect user intent related to *contract redlining assistant*
...
- **Sub-tasks:**
  1. Parse and validate the input for *contract redlining assistant* context
  2. `Construct enterprise DAG strategy matching Contract Redlining Assistant`
...
skill:
  id: LEG-091
  name: "Contract Redlining Assistant"
  domain: Legal
  version: 1.0.0
  difficulty: Advanced
  type: Generative
