---
name: EDU-059-dual-coding-activity-designer
...
- **Intent:** Detect user intent related to *dual coding activity designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *dual coding activity designer* context
  2. `Construct enterprise DAG strategy matching Dual Coding Activity Designer`
...
skill:
  id: EDU-059
  name: "Dual Coding Activity Designer"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
