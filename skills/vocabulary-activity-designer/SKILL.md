---
name: EDU-086-vocabulary-activity-designer
...
- **Intent:** Detect user intent related to *vocabulary activity designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *vocabulary activity designer* context
  2. `Construct enterprise DAG strategy matching Vocabulary Activity Designer`
...
skill:
  id: EDU-086
  name: "Vocabulary Activity Designer"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Generative
