---
name: FIN-034-rebalancing-strategy-planner
...
- **Intent:** Detect user intent related to *rebalancing strategy planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *rebalancing strategy planner* context
  2. `Construct enterprise DAG strategy matching Rebalancing Strategy Planner`
...
skill:
  id: FIN-034
  name: "Rebalancing Strategy Planner"
  domain: Finance
  version: 1.0.0
  difficulty: Intermediate
  type: Conversational
