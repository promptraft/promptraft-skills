---
name: DAT-089-tabular-data-synthesizer
...
- **Intent:** Detect user intent related to *tabular data synthesizer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *tabular data synthesizer* context
  2. `Construct enterprise DAG strategy matching Tabular Data Synthesizer`
