---
name: LEG-089-legal-research-summarizer
...
- **Intent:** Detect user intent related to *legal research summarizer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *legal research summarizer* context
  2. `Construct enterprise DAG strategy matching Legal Research Summarizer`
