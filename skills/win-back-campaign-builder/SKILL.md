---
name: MAR-071-win-back-campaign-builder
...
- **Intent:** Detect user intent related to *win-back campaign builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *win-back campaign builder* context
  2. `Construct enterprise DAG strategy matching Win-back Campaign Builder`
...
skill:
  id: MAR-071
  name: "Win-back Campaign Builder"
  domain: Marketing
  version: 1.0.0
  difficulty: Advanced
  type: Generative
