---
name: LEG-011-trademark-search-assistant
...
- **Intent:** Detect user intent related to *trademark search assistant*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *trademark search assistant* context
  2. `Construct enterprise DAG strategy matching Trademark Search Assistant`
...
skill:
  id: LEG-011
  name: "Trademark Search Assistant"
  domain: Legal
  version: 1.0.0
  difficulty: Advanced
  type: Generative
