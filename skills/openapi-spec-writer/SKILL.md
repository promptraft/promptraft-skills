---
name: WEB-053-openapi-spec-writer
...
- **Intent:** Detect user intent related to *openapi spec writer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *openapi spec writer* context
  2. `Construct enterprise DAG strategy matching OpenAPI Spec Writer`
