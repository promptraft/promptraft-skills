---
name: HR-033-engagement-survey-builder
...
- **Intent:** Detect user intent related to *engagement survey builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *engagement survey builder* context
  2. `Construct enterprise DAG strategy matching Engagement Survey Builder`
...
skill:
  id: HR-033
  name: "Engagement Survey Builder"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Agentic
