...
# AR/VR Web Experience

> **Skill ID:** `WEB-071` · **Domain:** Web Development · **Type:** Generative
...
- **Intent Detection:** Classify the user request as one of: create / analyze / refactor / audit / report for the *ar/vr web experience* context
- **Entities to Extract:**
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Classify the AR/VR Web Experience request: new build vs. refactor vs. audit
...
- **Confidence Score:** Append `[confidence: XX% · skill: WEB-071]` to every output
