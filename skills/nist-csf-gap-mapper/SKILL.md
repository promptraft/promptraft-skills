---
name: SEC-065-nist-csf-gap-mapper
...
- **Intent:** Detect user intent related to *nist csf gap mapper*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *nist csf gap mapper* context
  2. `Construct enterprise DAG strategy matching NIST CSF Gap Mapper`
