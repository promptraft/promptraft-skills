---
name: HR-081-payroll-integration-mapper
...
- **Intent:** Detect user intent related to *payroll integration mapper*
...
- **Sub-tasks:**
  1. Parse and validate the input for *payroll integration mapper* context
  2. `Construct enterprise DAG strategy matching Payroll Integration Mapper`
...
skill:
  id: HR-081
  name: "Payroll Integration Mapper"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Generative
