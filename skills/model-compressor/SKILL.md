...
- **Intent:** Detect user intent related to *model compressor*
...
- **Sub-tasks:**
  1. Parse and validate the input for *model compressor* context
  2. `Construct enterprise DAG strategy matching Model Compressor`
