...
- **Intent:** Detect user intent related to *image optimizer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *image optimizer* context
  2. `Construct enterprise DAG strategy matching Image Optimizer`
