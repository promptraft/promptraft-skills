---
name: DAT-034-feature-importance-ranker
...
- **Intent:** Detect user intent related to *feature importance ranker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *feature importance ranker* context
  2. `Construct enterprise DAG strategy matching Feature Importance Ranker`
...
skill:
  id: DAT-034
  name: "Feature Importance Ranker"
  domain: Data Science
  version: 1.0.0
  difficulty: Intermediate
  type: Conversational
