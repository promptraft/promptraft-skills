---
name: HR-065-pay-transparency-implementer
...
- **Intent:** Detect user intent related to *pay transparency implementer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *pay transparency implementer* context
  2. `Construct enterprise DAG strategy matching Pay Transparency Implementer`
...
skill:
  id: HR-065
  name: "Pay Transparency Implementer"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Transformative
