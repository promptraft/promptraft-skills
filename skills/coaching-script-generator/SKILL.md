---
name: HR-030-coaching-script-generator
...
- **Intent:** Detect user intent related to *coaching script generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *coaching script generator* context
  2. `Construct enterprise DAG strategy matching Coaching Script Generator`
...
skill:
  id: HR-030
  name: "Coaching Script Generator"
  domain: Human Resources
  version: 1.0.0
  difficulty: Intermediate
  type: Transformative
