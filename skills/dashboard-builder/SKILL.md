---
name: DAT-041-dashboard-builder
...
- **Intent:** Detect user intent related to *dashboard builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *dashboard builder* context
  2. `Construct enterprise DAG strategy matching Dashboard Builder`
