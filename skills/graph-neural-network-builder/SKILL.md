---
name: DAT-067-graph-neural-network-builder
...
- **Intent:** Detect user intent related to *graph neural network builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *graph neural network builder* context
  2. `Construct enterprise DAG strategy matching Graph Neural Network Builder`
...
skill:
  id: DAT-067
  name: "Graph Neural Network Builder"
  domain: Data Science
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
