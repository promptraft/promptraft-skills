---
name: EDU-041-plagiarism-prevention-guide
...
- **Intent:** Detect user intent related to *plagiarism prevention guide*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *plagiarism prevention guide* context
  2. `Construct enterprise DAG strategy matching Plagiarism Prevention Guide`
...
skill:
  id: EDU-041
  name: "Plagiarism Prevention Guide"
  domain: Education
  version: 1.0.0
  difficulty: Beginner
  type: Generative
