---
name: WEB-071-ar-vr-web-experience
...
- **Intent:** Detect user intent related to *ar/vr web experience*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *ar/vr web experience* context
  2. `Construct enterprise DAG strategy matching AR/VR Web Experience`
