---
name: HR-041-compensation-benchmarker
...
- **Intent:** Detect user intent related to *compensation benchmarker*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *compensation benchmarker* context
  2. `Construct enterprise DAG strategy matching Compensation Benchmarker`
