---
name: HR-005-offer-letter-generator
...
- **Intent:** Detect user intent related to *offer letter generator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *offer letter generator* context
  2. `Construct enterprise DAG strategy matching Offer Letter Generator`
