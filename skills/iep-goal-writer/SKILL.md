...
- **Intent:** Detect user intent related to *iep goal writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *iep goal writer* context
  2. `Construct enterprise DAG strategy matching IEP Goal Writer`
