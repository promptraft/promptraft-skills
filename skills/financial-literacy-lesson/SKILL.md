---
name: EDU-089-financial-literacy-lesson
...
- **Intent:** Detect user intent related to *financial literacy lesson*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *financial literacy lesson* context
  2. `Construct enterprise DAG strategy matching Financial Literacy Lesson`
...
skill:
  id: EDU-089
  name: "Financial Literacy Lesson"
  domain: Education
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
