---
name: SEC-028-sase-architecture-planner
...
- **Intent:** Detect user intent related to *sase architecture planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *sase architecture planner* context
  2. `Construct enterprise DAG strategy matching SASE Architecture Planner`
...
skill:
  id: SEC-028
  name: "SASE Architecture Planner"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Expert
  type: Agentic
