---
name: LEG-053-right-of-first-refusal-clause
...
- **Intent:** Detect user intent related to *right of first refusal clause*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *right of first refusal clause* context
  2. `Construct enterprise DAG strategy matching Right of First Refusal Clause`
