---
name: LEG-068-benefits-compliance-checker
...
- **Intent:** Detect user intent related to *benefits compliance checker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *benefits compliance checker* context
  2. `Construct enterprise DAG strategy matching Benefits Compliance Checker`
...
skill:
  id: LEG-068
  name: "Benefits Compliance Checker"
  domain: Legal
  version: 1.0.0
  difficulty: Expert
  type: Agentic
