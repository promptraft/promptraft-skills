---
name: LEG-077-whistleblower-policy-generator
...
- **Intent:** Detect user intent related to *whistleblower policy generator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *whistleblower policy generator* context
  2. `Construct enterprise DAG strategy matching Whistleblower Policy Generator`
...
skill:
  id: LEG-077
  name: "Whistleblower Policy Generator"
  domain: Legal
  version: 1.0.0
  difficulty: Beginner
  type: Analytical
