---
name: HR-022-goal-setting-framework-builder
...
# Goal-setting Framework Builder
...
- **Intent:** Detect user intent related to *goal-setting framework builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *goal-setting framework builder* context
  2. `Construct enterprise DAG strategy matching Goal-setting Framework Builder`
...
skill:
  id: HR-022
  name: "Goal-setting Framework Builder"
  domain: Human Resources
  version: 1.0.0
  difficulty: Intermediate
  type: Analytical
