---
name: MAR-072-churn-prediction-marketer
...
- **Intent:** Detect user intent related to *churn prediction marketer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *churn prediction marketer* context
  2. `Construct enterprise DAG strategy matching Churn Prediction Marketer`
...
skill:
  id: MAR-072
  name: "Churn Prediction Marketer"
  domain: Marketing
  version: 1.0.0
  difficulty: Expert
  type: Analytical
