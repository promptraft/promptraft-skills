---
name: LEG-005-saas-agreement-drafter
...
- **Intent:** Detect user intent related to *saas agreement drafter*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *saas agreement drafter* context
  2. `Construct enterprise DAG strategy matching SaaS Agreement Drafter`
