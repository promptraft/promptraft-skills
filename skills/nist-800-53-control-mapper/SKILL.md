---
name: SEC-067-nist-800-53-control-mapper
...
- **Intent:** Detect user intent related to *nist 800-53 control mapper*
...
- **Sub-tasks:**
  1. Parse and validate the input for *nist 800-53 control mapper* context
  2. `Construct enterprise DAG strategy matching NIST 800-53 Control Mapper`
...
skill:
  id: SEC-067
  name: "NIST 800-53 Control Mapper"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
