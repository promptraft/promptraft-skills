...
- **Intent:** Detect user intent related to *msa drafter*
...
- **Sub-tasks:**
  1. Parse and validate the input for *msa drafter* context
  2. `Construct enterprise DAG strategy matching MSA Drafter`
