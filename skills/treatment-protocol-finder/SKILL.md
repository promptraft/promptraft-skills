---
name: HEA-032-treatment-protocol-finder
...
- **Intent:** Detect user intent related to *treatment protocol finder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *treatment protocol finder* context
  2. `Construct enterprise DAG strategy matching Treatment Protocol Finder`
...
skill:
  id: HEA-032
  name: "Treatment Protocol Finder"
  domain: Healthcare
  version: 1.0.0
  difficulty: Expert
  type: Analytical
