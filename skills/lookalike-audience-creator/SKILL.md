---
name: MAR-036-lookalike-audience-creator
...
- **Intent:** Detect user intent related to *lookalike audience creator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *lookalike audience creator* context
  2. `Construct enterprise DAG strategy matching Lookalike Audience Creator`
...
skill:
  id: MAR-036
  name: "Lookalike Audience Creator"
  domain: Marketing
  version: 1.0.0
  difficulty: Expert
  type: Generative
