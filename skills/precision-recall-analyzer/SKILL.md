---
name: DAT-052-precision-recall-analyzer
...
- **Intent:** Detect user intent related to *precision-recall analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *precision-recall analyzer* context
  2. `Construct enterprise DAG strategy matching Precision-Recall Analyzer`
...
skill:
  id: DAT-052
  name: "Precision-Recall Analyzer"
  domain: Data Science
  version: 1.0.0
  difficulty: Expert
  type: Analytical
