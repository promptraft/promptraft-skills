---
name: HR-053-ada-interactive-process-guide
...
- **Intent:** Detect user intent related to *ada interactive process guide*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *ada interactive process guide* context
  2. `Construct enterprise DAG strategy matching ADA Interactive Process Guide`
...
skill:
  id: HR-053
  name: "ADA Interactive Process Guide"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Agentic
