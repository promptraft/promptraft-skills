...
- **Intent:** Detect user intent related to *pdf generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pdf generator* context
  2. `Construct enterprise DAG strategy matching PDF Generator`
