...
- **Intent:** Detect user intent related to *roi calculator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *roi calculator* context
  2. `Construct enterprise DAG strategy matching ROI Calculator`
