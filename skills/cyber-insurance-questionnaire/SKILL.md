---
name: SEC-080-cyber-insurance-questionnaire
...
- **Intent:** Detect user intent related to *cyber insurance questionnaire*
...
- **Sub-tasks:**
  1. Parse and validate the input for *cyber insurance questionnaire* context
  2. `Construct enterprise DAG strategy matching Cyber Insurance Questionnaire`
...
skill:
  id: SEC-080
  name: "Cyber Insurance Questionnaire"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Expert
  type: Transformative
