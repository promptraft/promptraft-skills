...
- **Intent:** Detect user intent related to *capa tracker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *capa tracker* context
  2. `Construct enterprise DAG strategy matching CAPA Tracker`
