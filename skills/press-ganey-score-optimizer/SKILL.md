---
name: HEA-090-press-ganey-score-optimizer
...
- **Intent:** Detect user intent related to *press ganey score optimizer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *press ganey score optimizer* context
  2. `Construct enterprise DAG strategy matching Press Ganey Score Optimizer`
...
skill:
  id: HEA-090
  name: "Press Ganey Score Optimizer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Intermediate
  type: Transformative
