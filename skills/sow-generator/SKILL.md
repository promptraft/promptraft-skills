...
- **Intent:** Detect user intent related to *sow generator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *sow generator* context
  2. `Construct enterprise DAG strategy matching SOW Generator`
