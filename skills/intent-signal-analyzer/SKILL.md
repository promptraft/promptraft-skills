---
name: MAR-095-intent-signal-analyzer
...
- **Intent:** Detect user intent related to *intent signal analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *intent signal analyzer* context
  2. `Construct enterprise DAG strategy matching Intent Signal Analyzer`
