---
name: SEC-081-regulatory-breach-notifier
...
- **Intent:** Detect user intent related to *regulatory breach notifier*
...
- **Sub-tasks:**
  1. Parse and validate the input for *regulatory breach notifier* context
  2. `Construct enterprise DAG strategy matching Regulatory Breach Notifier`
...
skill:
  id: SEC-081
  name: "Regulatory Breach Notifier"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Beginner
  type: Generative
