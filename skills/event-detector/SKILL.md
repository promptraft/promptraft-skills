...
- **Intent:** Detect user intent related to *event detector*
...
- **Sub-tasks:**
  1. Parse and validate the input for *event detector* context
  2. `Construct enterprise DAG strategy matching Event Detector`
