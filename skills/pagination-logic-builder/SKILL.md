---
name: WEB-040-pagination-logic-builder
...
- **Intent:** Detect user intent related to *pagination logic builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pagination logic builder* context
  2. `Construct enterprise DAG strategy matching Pagination Logic Builder`
...
- **Secondary Tool:** `GitHub Copilot` — `Provides validation, fallback, or post-processing security checks`
- **Execution Order:** `Parallel (unless specifically blocked)`
- **Error Handling:** Retry × 2 → fallback tool → graceful error message
- **Data Flow:** `Stripe API output → AST & Schema normalizer → GitHub Copilot input`
