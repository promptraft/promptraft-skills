...
- **Intent:** Detect user intent related to *swot generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *swot generator* context
  2. `Construct enterprise DAG strategy matching SWOT Generator`
