---
name: EDU-071-field-trip-planner
...
- **Intent:** Detect user intent related to *field trip planner*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *field trip planner* context
  2. `Construct enterprise DAG strategy matching Field Trip Planner`
