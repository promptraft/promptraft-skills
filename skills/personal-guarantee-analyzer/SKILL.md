---
name: LEG-060-personal-guarantee-analyzer
...
- **Intent:** Detect user intent related to *personal guarantee analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *personal guarantee analyzer* context
  2. `Construct enterprise DAG strategy matching Personal Guarantee Analyzer`
...
skill:
  id: LEG-060
  name: "Personal Guarantee Analyzer"
  domain: Legal
  version: 1.0.0
  difficulty: Expert
  type: Transformative
