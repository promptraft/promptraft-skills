---
name: WEB-093-responsive-breakpoint-manager
...
- **Intent:** Detect user intent related to *responsive breakpoint manager*
...
- **Sub-tasks:**
  1. Parse and validate the input for *responsive breakpoint manager* context
  2. `Construct enterprise DAG strategy matching Responsive Breakpoint Manager`
...
skill:
  id: WEB-093
  name: "Responsive Breakpoint Manager"
  domain: Web Development
  version: 1.0.0
  difficulty: Beginner
  type: Agentic
