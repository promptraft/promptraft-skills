---
name: SEC-095-scada-risk-assessor
...
- **Intent:** Detect user intent related to *scada risk assessor*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *scada risk assessor* context
  2. `Construct enterprise DAG strategy matching SCADA Risk Assessor`
