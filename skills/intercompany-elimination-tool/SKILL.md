---
name: FIN-061-intercompany-elimination-tool
...
- **Intent:** Detect user intent related to *intercompany elimination tool*
...
- **Sub-tasks:**
  1. Parse and validate the input for *intercompany elimination tool* context
  2. `Construct enterprise DAG strategy matching Intercompany Elimination Tool`
...
skill:
  id: FIN-061
  name: "Intercompany Elimination Tool"
  domain: Finance
  version: 1.0.0
  difficulty: Beginner
  type: Generative
