---
name: FIN-038-impact-investment-analyzer
...
- **Intent:** Detect user intent related to *impact investment analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *impact investment analyzer* context
  2. `Construct enterprise DAG strategy matching Impact Investment Analyzer`
...
skill:
  id: FIN-038
  name: "Impact Investment Analyzer"
  domain: Finance
  version: 1.0.0
  difficulty: Intermediate
  type: Agentic
