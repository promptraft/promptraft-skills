---
name: LEG-047-asset-purchase-agreement
...
- **Intent:** Detect user intent related to *asset purchase agreement*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *asset purchase agreement* context
  2. `Construct enterprise DAG strategy matching Asset Purchase Agreement`
