---
name: FIN-011-unit-economics-modeler
...
- **Intent:** Detect user intent related to *unit economics modeler*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *unit economics modeler* context
  2. `Construct enterprise DAG strategy matching Unit Economics Modeler`
