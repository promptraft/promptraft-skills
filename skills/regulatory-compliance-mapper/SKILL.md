---
name: LEG-019-regulatory-compliance-mapper
...
- **Intent:** Detect user intent related to *regulatory compliance mapper*
...
- **Sub-tasks:**
  1. Parse and validate the input for *regulatory compliance mapper* context
  2. `Construct enterprise DAG strategy matching Regulatory Compliance Mapper`
...
skill:
  id: LEG-019
  name: "Regulatory Compliance Mapper"
  domain: Legal
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
