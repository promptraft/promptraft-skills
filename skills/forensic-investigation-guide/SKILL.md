---
name: SEC-019-forensic-investigation-guide
...
- **Intent:** Detect user intent related to *forensic investigation guide*
...
- **Sub-tasks:**
  1. Parse and validate the input for *forensic investigation guide* context
  2. `Construct enterprise DAG strategy matching Forensic Investigation Guide`
...
skill:
  id: SEC-019
  name: "Forensic Investigation Guide"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
