---
name: HEA-066-mindfulness-script-writer
...
- **Intent:** Detect user intent related to *mindfulness script writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *mindfulness script writer* context
  2. `Construct enterprise DAG strategy matching Mindfulness Script Writer`
...
skill:
  id: HEA-066
  name: "Mindfulness Script Writer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Intermediate
  type: Generative
