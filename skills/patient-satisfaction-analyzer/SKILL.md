---
name: HEA-089-patient-satisfaction-analyzer
...
- **Intent:** Detect user intent related to *patient satisfaction analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *patient satisfaction analyzer* context
  2. `Construct enterprise DAG strategy matching Patient Satisfaction Analyzer`
...
skill:
  id: HEA-089
  name: "Patient Satisfaction Analyzer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
