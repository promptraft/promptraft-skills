...
- **Intent:** Detect user intent related to *wacc calculator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *wacc calculator* context
  2. `Construct enterprise DAG strategy matching WACC Calculator`
