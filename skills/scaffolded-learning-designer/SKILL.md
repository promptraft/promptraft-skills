---
name: EDU-018-scaffolded-learning-designer
...
- **Intent:** Detect user intent related to *scaffolded learning designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *scaffolded learning designer* context
  2. `Construct enterprise DAG strategy matching Scaffolded Learning Designer`
...
skill:
  id: EDU-018
  name: "Scaffolded Learning Designer"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Agentic
