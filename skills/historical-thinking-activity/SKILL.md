---
name: EDU-087-historical-thinking-activity
...
- **Intent:** Detect user intent related to *historical thinking activity*
...
- **Sub-tasks:**
  1. Parse and validate the input for *historical thinking activity* context
  2. `Construct enterprise DAG strategy matching Historical Thinking Activity`
...
skill:
  id: EDU-087
  name: "Historical Thinking Activity"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
