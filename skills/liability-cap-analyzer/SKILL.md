---
name: LEG-035-liability-cap-analyzer
...
- **Intent:** Detect user intent related to *liability cap analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *liability cap analyzer* context
  2. `Construct enterprise DAG strategy matching Liability Cap Analyzer`
