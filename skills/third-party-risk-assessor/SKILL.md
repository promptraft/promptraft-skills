---
name: SEC-083-third-party-risk-assessor
...
- **Intent:** Detect user intent related to *third-party risk assessor*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *third-party risk assessor* context
  2. `Construct enterprise DAG strategy matching Third-party Risk Assessor`
