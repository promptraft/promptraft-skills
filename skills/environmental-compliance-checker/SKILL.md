---
name: LEG-065-environmental-compliance-checker
...
- **Intent:** Detect user intent related to *environmental compliance checker*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *environmental compliance checker* context
  2. `Construct enterprise DAG strategy matching Environmental Compliance Checker`
