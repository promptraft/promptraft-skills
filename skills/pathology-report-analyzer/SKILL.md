---
name: HEA-027-pathology-report-analyzer
...
- **Intent:** Detect user intent related to *pathology report analyzer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pathology report analyzer* context
  2. `Construct enterprise DAG strategy matching Pathology Report Analyzer`
...
skill:
  id: HEA-027
  name: "Pathology Report Analyzer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
