---
name: WEB-035-e2e-test-script-writer
...
- **Intent:** Detect user intent related to *e2e test script writer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *e2e test script writer* context
  2. `Construct enterprise DAG strategy matching E2E Test Script Writer`
