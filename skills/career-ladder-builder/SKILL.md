---
name: HR-017-career-ladder-builder
...
- **Intent:** Detect user intent related to *career ladder builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *career ladder builder* context
  2. `Construct enterprise DAG strategy matching Career Ladder Builder`
