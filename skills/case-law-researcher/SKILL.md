---
name: LEG-017-case-law-researcher
...
- **Intent:** Detect user intent related to *case law researcher*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *case law researcher* context
  2. `Construct enterprise DAG strategy matching Case Law Researcher`
