---
name: LEG-032-arbitration-clause-builder
...
- **Intent:** Detect user intent related to *arbitration clause builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *arbitration clause builder* context
  2. `Construct enterprise DAG strategy matching Arbitration Clause Builder`
...
skill:
  id: LEG-032
  name: "Arbitration Clause Builder"
  domain: Legal
  version: 1.0.0
  difficulty: Expert
  type: Analytical
