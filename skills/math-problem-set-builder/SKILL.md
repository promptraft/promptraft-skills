---
name: EDU-083-math-problem-set-builder
...
- **Intent:** Detect user intent related to *math problem set builder*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *math problem set builder* context
  2. `Construct enterprise DAG strategy matching Math Problem Set Builder`
