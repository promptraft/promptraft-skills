---
name: SEC-011-zero-day-response-planner
...
- **Intent:** Detect user intent related to *zero-day response planner*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *zero-day response planner* context
  2. `Construct enterprise DAG strategy matching Zero-day Response Planner`
...
skill:
  id: SEC-011
  name: "Zero-day Response Planner"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Advanced
  type: Generative
