...
- **Intent:** Detect user intent related to *3d scene builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *3d scene builder* context
  2. `Construct enterprise DAG strategy matching 3D Scene Builder`
