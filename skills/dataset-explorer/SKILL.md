...
- **Intent:** Detect user intent related to *dataset explorer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *dataset explorer* context
  2. `Construct enterprise DAG strategy matching Dataset Explorer`
