---
name: FIN-062-segment-reporting-builder
...
- **Intent:** Detect user intent related to *segment reporting builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *segment reporting builder* context
  2. `Construct enterprise DAG strategy matching Segment Reporting Builder`
...
skill:
  id: FIN-062
  name: "Segment Reporting Builder"
  domain: Finance
  version: 1.0.0
  difficulty: Intermediate
  type: Analytical
