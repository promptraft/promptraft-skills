---
name: DAT-023-bayesian-analyzer
...
- **Intent:** Detect user intent related to *bayesian analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *bayesian analyzer* context
  2. `Construct enterprise DAG strategy matching Bayesian Analyzer`
