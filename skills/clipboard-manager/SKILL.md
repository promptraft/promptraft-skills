---
name: WEB-101-clipboard-manager
...
- **Intent:** Detect user intent related to *clipboard manager*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *clipboard manager* context
  2. `Construct enterprise DAG strategy matching Clipboard Manager`
