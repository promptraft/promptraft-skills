---
name: MAR-069-freemium-conversion-planner
...
- **Intent:** Detect user intent related to *freemium conversion planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *freemium conversion planner* context
  2. `Construct enterprise DAG strategy matching Freemium Conversion Planner`
...
skill:
  id: MAR-069
  name: "Freemium Conversion Planner"
  domain: Marketing
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
