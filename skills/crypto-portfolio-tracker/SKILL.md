---
name: FIN-077-crypto-portfolio-tracker
...
- **Intent:** Detect user intent related to *crypto portfolio tracker*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *crypto portfolio tracker* context
  2. `Construct enterprise DAG strategy matching Crypto Portfolio Tracker`
