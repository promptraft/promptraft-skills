---
name: MAR-011-social-media-caption-writer
...
- **Intent:** Detect user intent related to *social media caption writer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *social media caption writer* context
  2. `Construct enterprise DAG strategy matching Social Media Caption Writer`
