---
name: HEA-040-regulatory-submission-writer
...
- **Intent:** Detect user intent related to *regulatory submission writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *regulatory submission writer* context
  2. `Construct enterprise DAG strategy matching Regulatory Submission Writer`
...
skill:
  id: HEA-040
  name: "Regulatory Submission Writer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Expert
  type: Transformative
