---
name: HEA-050-infection-control-auditor
...
- **Intent:** Detect user intent related to *infection control auditor*
...
- **Sub-tasks:**
  1. Parse and validate the input for *infection control auditor* context
  2. `Construct enterprise DAG strategy matching Infection Control Auditor`
...
skill:
  id: HEA-050
  name: "Infection Control Auditor"
  domain: Healthcare
  version: 1.0.0
  difficulty: Intermediate
  type: Transformative
