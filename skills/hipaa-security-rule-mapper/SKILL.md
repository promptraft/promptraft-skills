---
name: SEC-071-hipaa-security-rule-mapper
...
- **Intent:** Detect user intent related to *hipaa security rule mapper*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *hipaa security rule mapper* context
  2. `Construct enterprise DAG strategy matching HIPAA Security Rule Mapper`
...
skill:
  id: SEC-071
  name: "HIPAA Security Rule Mapper"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Advanced
  type: Generative
