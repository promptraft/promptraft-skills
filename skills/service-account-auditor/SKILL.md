---
name: SEC-035-service-account-auditor
...
- **Intent:** Detect user intent related to *service account auditor*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *service account auditor* context
  2. `Construct enterprise DAG strategy matching Service Account Auditor`
