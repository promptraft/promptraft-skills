---
name: MAR-038-attribution-report-builder
...
- **Intent:** Detect user intent related to *attribution report builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *attribution report builder* context
  2. `Construct enterprise DAG strategy matching Attribution Report Builder`
...
skill:
  id: MAR-038
  name: "Attribution Report Builder"
  domain: Marketing
  version: 1.0.0
  difficulty: Intermediate
  type: Agentic
