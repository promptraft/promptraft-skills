...
- **Intent:** Detect user intent related to *okr designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *okr designer* context
  2. `Construct enterprise DAG strategy matching OKR Designer`
