---
name: EDU-019-project-based-learning-planner
...
- **Intent:** Detect user intent related to *project-based learning planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *project-based learning planner* context
  2. `Construct enterprise DAG strategy matching Project-based Learning Planner`
...
skill:
  id: EDU-019
  name: "Project-based Learning Planner"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
