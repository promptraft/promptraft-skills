...
- **Intent:** Detect user intent related to *var calculator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *var calculator* context
  2. `Construct enterprise DAG strategy matching VaR Calculator`
