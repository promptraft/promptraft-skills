---
name: WEB-059-chart-integration-specialist
...
- **Intent:** Detect user intent related to *chart integration specialist*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *chart integration specialist* context
  2. `Construct enterprise DAG strategy matching Chart Integration Specialist`
...
skill:
  id: WEB-059
  name: "Chart Integration Specialist"
  domain: Web Development
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
