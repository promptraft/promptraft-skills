---
name: HEA-051-sterile-processing-tracker
...
- **Intent:** Detect user intent related to *sterile processing tracker*
...
- **Sub-tasks:**
  1. Parse and validate the input for *sterile processing tracker* context
  2. `Construct enterprise DAG strategy matching Sterile Processing Tracker`
...
skill:
  id: HEA-051
  name: "Sterile Processing Tracker"
  domain: Healthcare
  version: 1.0.0
  difficulty: Advanced
  type: Generative
