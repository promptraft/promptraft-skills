---
name: MAR-077-quora-answer-writer
...
- **Intent:** Detect user intent related to *quora answer writer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *quora answer writer* context
  2. `Construct enterprise DAG strategy matching Quora Answer Writer`
