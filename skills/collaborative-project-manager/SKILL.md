---
name: EDU-039-collaborative-project-manager
...
- **Intent:** Detect user intent related to *collaborative project manager*
...
- **Sub-tasks:**
  1. Parse and validate the input for *collaborative project manager* context
  2. `Construct enterprise DAG strategy matching Collaborative Project Manager`
...
skill:
  id: EDU-039
  name: "Collaborative Project Manager"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
