---
name: EDU-022-simulation-exercise-builder
...
- **Intent:** Detect user intent related to *simulation exercise builder*
...
- **Sub-tasks:**
  1. Parse and validate the input for *simulation exercise builder* context
  2. `Construct enterprise DAG strategy matching Simulation Exercise Builder`
...
skill:
  id: EDU-022
  name: "Simulation Exercise Builder"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Analytical
