---
name: SEC-075-security-champions-curriculum
...
- **Intent:** Detect user intent related to *security champions curriculum*
...
- **Sub-tasks:**
  1. Parse and validate the input for *security champions curriculum* context
  2. `Construct enterprise DAG strategy matching Security Champions Curriculum`
...
skill:
  id: SEC-075
  name: "Security Champions Curriculum"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Advanced
  type: Transformative
