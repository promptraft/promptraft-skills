...
- **Intent:** Detect user intent related to *pos tagger*
...
- **Sub-tasks:**
  1. Parse and validate the input for *pos tagger* context
  2. `Construct enterprise DAG strategy matching POS Tagger`
