---
name: LEG-099-llc-operating-agreement-optimizer
...
# LLC Operating Agreement Optimizer
...
- **Intent:** Detect user intent related to *llc operating agreement optimizer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *llc operating agreement optimizer* context
  2. `Construct enterprise DAG strategy matching LLC Operating Agreement Optimizer`
...
skill:
  id: LEG-099
  name: "LLC Operating Agreement Optimizer"
  domain: Legal
  version: 1.0.0
  difficulty: Advanced
  type: Conversational
