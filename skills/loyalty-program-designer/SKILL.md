---
name: MAR-047-loyalty-program-designer
...
- **Intent:** Detect user intent related to *loyalty program designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *loyalty program designer* context
  2. `Construct enterprise DAG strategy matching Loyalty Program Designer`
