---
name: WEB-005-react-state-manager
...
- **Intent:** Detect user intent related to *react state manager*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *react state manager* context
  2. `Construct enterprise DAG strategy matching React State Manager`
