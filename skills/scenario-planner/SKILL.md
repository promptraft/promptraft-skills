...
- **Intent:** Detect user intent related to *scenario planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *scenario planner* context
  2. `Construct enterprise DAG strategy matching Scenario Planner`
