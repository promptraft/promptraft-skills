---
name: DAT-077-dependency-parser
...
- **Intent:** Detect user intent related to *dependency parser*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *dependency parser* context
  2. `Construct enterprise DAG strategy matching Dependency Parser`
