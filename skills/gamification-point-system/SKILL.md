---
name: EDU-025-gamification-point-system
...
- **Intent:** Detect user intent related to *gamification point system*
...
- **Sub-tasks:**
  1. Parse and validate the input for *gamification point system* context
  2. `Construct enterprise DAG strategy matching Gamification Point System`
...
skill:
  id: EDU-025
  name: "Gamification Point System"
  domain: Education
  version: 1.0.0
  difficulty: Beginner
  type: Transformative
