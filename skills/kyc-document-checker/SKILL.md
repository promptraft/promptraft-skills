---
name: FIN-071-kyc-document-checker
...
- **Intent:** Detect user intent related to *kyc document checker*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *kyc document checker* context
  2. `Construct enterprise DAG strategy matching KYC Document Checker`
