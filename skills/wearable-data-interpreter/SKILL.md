---
name: HEA-059-wearable-data-interpreter
...
- **Intent:** Detect user intent related to *wearable data interpreter*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *wearable data interpreter* context
  2. `Construct enterprise DAG strategy matching Wearable Data Interpreter`
