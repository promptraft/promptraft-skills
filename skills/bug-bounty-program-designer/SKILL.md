---
name: SEC-007-bug-bounty-program-designer
...
- **Intent:** Detect user intent related to *bug bounty program designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *bug bounty program designer* context
  2. `Construct enterprise DAG strategy matching Bug Bounty Program Designer`
...
skill:
  id: SEC-007
  name: "Bug Bounty Program Designer"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
