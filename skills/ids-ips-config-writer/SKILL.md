---
name: SEC-023-ids-ips-config-writer
...
- **Intent:** Detect user intent related to *ids/ips config writer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *ids/ips config writer* context
  2. `Construct enterprise DAG strategy matching IDS/IPS Config Writer`
