---
name: EDU-011-discussion-prompt-generator
...
- **Intent:** Detect user intent related to *discussion prompt generator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *discussion prompt generator* context
  2. `Construct enterprise DAG strategy matching Discussion Prompt Generator`
