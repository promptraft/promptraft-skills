---
name: DAT-029-experiment-designer
...
- **Intent:** Detect user intent related to *experiment designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *experiment designer* context
  2. `Construct enterprise DAG strategy matching Experiment Designer`
