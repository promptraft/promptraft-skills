...
- **Intent:** Detect user intent related to *nda generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *nda generator* context
  2. `Construct enterprise DAG strategy matching NDA Generator`
