---
name: DAT-095-batch-prediction-runner
...
- **Intent:** Detect user intent related to *batch prediction runner*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *batch prediction runner* context
  2. `Construct enterprise DAG strategy matching Batch Prediction Runner`
