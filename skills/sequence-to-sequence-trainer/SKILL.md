---
name: DAT-074-sequence-to-sequence-trainer
...
- **Intent:** Detect user intent related to *sequence-to-sequence trainer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *sequence-to-sequence trainer* context
  2. `Construct enterprise DAG strategy matching Sequence-to-Sequence Trainer`
...
skill:
  id: DAT-074
  name: "Sequence-to-Sequence Trainer"
  domain: Data Science
  version: 1.0.0
  difficulty: Intermediate
  type: Conversational
