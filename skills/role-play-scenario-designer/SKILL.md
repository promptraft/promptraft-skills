---
name: EDU-023-role-play-scenario-designer
...
- **Intent:** Detect user intent related to *role-play scenario designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *role-play scenario designer* context
  2. `Construct enterprise DAG strategy matching Role-play Scenario Designer`
