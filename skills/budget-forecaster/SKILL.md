---
name: FIN-005-budget-forecaster
...
- **Intent:** Detect user intent related to *budget forecaster*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *budget forecaster* context
  2. `Construct enterprise DAG strategy matching Budget Forecaster`
