...
- **Intent:** Detect user intent related to *beta estimator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *beta estimator* context
  2. `Construct enterprise DAG strategy matching Beta Estimator`
