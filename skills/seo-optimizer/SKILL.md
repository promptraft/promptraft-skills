...
- **Intent:** Detect user intent related to *seo optimizer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *seo optimizer* context
  2. `Construct enterprise DAG strategy matching SEO Optimizer`
