---
name: HR-029-pip-performance-improvement-plan-writer
...
- **Intent:** Detect user intent related to *pip (performance improvement plan) writer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *pip (performance improvement plan) writer* context
  2. `Construct enterprise DAG strategy matching PIP (Performance Improvement Plan) Writer`
...
skill:
  id: HR-029
  name: "PIP (Performance Improvement Plan) Writer"
  domain: Human Resources
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
