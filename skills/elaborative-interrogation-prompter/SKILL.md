---
name: EDU-058-elaborative-interrogation-prompter
...
# Elaborative Interrogation Prompter
...
- **Intent:** Detect user intent related to *elaborative interrogation prompter*
...
- **Sub-tasks:**
  1. Parse and validate the input for *elaborative interrogation prompter* context
  2. `Construct enterprise DAG strategy matching Elaborative Interrogation Prompter`
...
skill:
  id: EDU-058
  name: "Elaborative Interrogation Prompter"
  domain: Education
  version: 1.0.0
  difficulty: Intermediate
  type: Agentic
