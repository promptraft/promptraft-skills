...
- **Intent:** Detect user intent related to *svg generator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *svg generator* context
  2. `Construct enterprise DAG strategy matching SVG Generator`
