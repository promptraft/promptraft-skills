---
name: FIN-069-capital-adequacy-assessor
...
- **Intent:** Detect user intent related to *capital adequacy assessor*
...
- **Sub-tasks:**
  1. Parse and validate the input for *capital adequacy assessor* context
  2. `Construct enterprise DAG strategy matching Capital Adequacy Assessor`
...
skill:
  id: FIN-069
  name: "Capital Adequacy Assessor"
  domain: Finance
  version: 1.0.0
  difficulty: Beginner
  type: Conversational
