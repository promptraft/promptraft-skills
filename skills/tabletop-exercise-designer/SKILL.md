---
name: SEC-076-tabletop-exercise-designer
...
- **Intent:** Detect user intent related to *tabletop exercise designer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *tabletop exercise designer* context
  2. `Construct enterprise DAG strategy matching Tabletop Exercise Designer`
...
skill:
  id: SEC-076
  name: "Tabletop Exercise Designer"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Expert
  type: Generative
