---
name: SEC-061-attack-simulation-planner
...
- **Intent:** Detect user intent related to *attack simulation planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *attack simulation planner* context
  2. `Construct enterprise DAG strategy matching Attack Simulation Planner`
...
skill:
  id: SEC-061
  name: "Attack Simulation Planner"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Beginner
  type: Generative
