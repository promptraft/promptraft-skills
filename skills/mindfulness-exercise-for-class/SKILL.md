---
name: EDU-063-mindfulness-exercise-for-class
...
# Mindfulness Exercise for Class
...
- **Intent:** Detect user intent related to *mindfulness exercise for class*
...
- **Sub-tasks:**
  1. Parse and validate the input for *mindfulness exercise for class* context
  2. `Construct enterprise DAG strategy matching Mindfulness Exercise for Class`
...
skill:
  id: EDU-063
  name: "Mindfulness Exercise for Class"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Agentic
