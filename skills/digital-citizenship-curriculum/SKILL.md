---
name: EDU-091-digital-citizenship-curriculum
...
- **Intent:** Detect user intent related to *digital citizenship curriculum*
...
- **Sub-tasks:**
  1. Parse and validate the input for *digital citizenship curriculum* context
  2. `Construct enterprise DAG strategy matching Digital Citizenship Curriculum`
...
skill:
  id: EDU-091
  name: "Digital Citizenship Curriculum"
  domain: Education
  version: 1.0.0
  difficulty: Advanced
  type: Generative
