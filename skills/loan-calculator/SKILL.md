...
- **Intent:** Detect user intent related to *loan calculator*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *loan calculator* context
  2. `Construct enterprise DAG strategy matching Loan Calculator`
