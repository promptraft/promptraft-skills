---
name: FIN-083-cost-benefit-analyzer
...
- **Intent:** Detect user intent related to *cost-benefit analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *cost-benefit analyzer* context
  2. `Construct enterprise DAG strategy matching Cost-benefit Analyzer`
