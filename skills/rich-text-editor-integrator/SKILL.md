---
name: WEB-067-rich-text-editor-integrator
...
- **Intent:** Detect user intent related to *rich text editor integrator*
...
- **Sub-tasks:**
  1. Parse and validate the input for *rich text editor integrator* context
  2. `Construct enterprise DAG strategy matching Rich Text Editor Integrator`
...
skill:
  id: WEB-067
  name: "Rich Text Editor Integrator"
  domain: Web Development
  version: 1.0.0
  difficulty: Advanced
  type: Analytical
