...
- **Intent:** Detect user intent related to *feature engineer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *feature engineer* context
  2. `Construct enterprise DAG strategy matching Feature Engineer`
