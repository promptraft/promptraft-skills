...
- **Intent:** Detect user intent related to *bcp/dr planner*
...
- **Sub-tasks:**
  1. Parse and validate the input for *bcp/dr planner* context
  2. `Construct enterprise DAG strategy matching BCP/DR Planner`
