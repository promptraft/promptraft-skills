---
name: HEA-077-population-health-analyzer
...
- **Intent:** Detect user intent related to *population health analyzer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *population health analyzer* context
  2. `Construct enterprise DAG strategy matching Population Health Analyzer`
