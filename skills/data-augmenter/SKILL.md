...
- **Intent:** Detect user intent related to *data augmenter*
...
- **Sub-tasks:**
  1. Parse and validate the input for *data augmenter* context
  2. `Construct enterprise DAG strategy matching Data Augmenter`
