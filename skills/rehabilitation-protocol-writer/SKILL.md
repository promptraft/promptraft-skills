---
name: HEA-070-rehabilitation-protocol-writer
...
# Rehabilitation Protocol Writer
...
- **Intent:** Detect user intent related to *rehabilitation protocol writer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *rehabilitation protocol writer* context
  2. `Construct enterprise DAG strategy matching Rehabilitation Protocol Writer`
...
skill:
  id: HEA-070
  name: "Rehabilitation Protocol Writer"
  domain: Healthcare
  version: 1.0.0
  difficulty: Intermediate
  type: Transformative
