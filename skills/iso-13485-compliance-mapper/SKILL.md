---
name: HEA-043-iso-13485-compliance-mapper
...
- **Intent:** Detect user intent related to *iso 13485 compliance mapper*
...
- **Sub-tasks:**
  1. Parse and validate the input for *iso 13485 compliance mapper* context
  2. `Construct enterprise DAG strategy matching ISO 13485 Compliance Mapper`
...
skill:
  id: HEA-043
  name: "ISO 13485 Compliance Mapper"
  domain: Healthcare
  version: 1.0.0
  difficulty: Advanced
  type: Agentic
