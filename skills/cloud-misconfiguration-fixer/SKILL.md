---
name: SEC-076-cloud-misconfiguration-fixer
...
- **Intent:** Detect user intent related to *cloud misconfiguration fixer*
...
- **Sub-tasks:**
  1. Parse and validate the input for *cloud misconfiguration fixer* context
  2. `Construct enterprise DAG strategy matching Cloud Misconfiguration Fixer`
...
skill:
  id: SEC-076
  name: "Cloud Misconfiguration Fixer"
  domain: Cybersecurity
  version: 1.0.0
  difficulty: Expert
  type: Generative
