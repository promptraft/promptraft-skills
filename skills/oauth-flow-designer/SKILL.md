---
name: WEB-017-oauth-flow-designer
...
- **Intent:** Detect user intent related to *oauth flow designer*
...
- **Strategy:** Reflexion
- **Sub-tasks:**
  1. Parse and validate the input for *oauth flow designer* context
  2. `Construct enterprise DAG strategy matching OAuth Flow Designer`
